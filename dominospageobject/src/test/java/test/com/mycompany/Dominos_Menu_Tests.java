 ...
 * @author swetu
 */
public class Dominos_Menu_Tests {
     private WebDriver driver;
    private String baseUrl;
    private JavascriptExecutor js;
    public Dominos_Menu_Tests() {
    }
    ...
    @Test
  public void TestMenu1() throws Exception {
  ...
  @Test
    public void TestMenu2() throws Exception {
        ...
        driver.get("https://www.dominos.com/en/pages/order/menu#!/menu/category/viewall/");
